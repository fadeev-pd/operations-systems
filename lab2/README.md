...
![Запуск блокнота через cmd](1_start_notepad.png)



**Отслеживание выполнения notepad.exe с помощью tasklist:**
![Отслеживание выполнения notepad.exe с помощью tasklist](2_notepad_task.png)
...
![Отслеживание выполнения wordpad.exe с помощью tasklist](8_wordpad_task.png)
