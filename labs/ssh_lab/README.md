...
**Цель работы:** одключившись по SSH, создать структуру каталогов и выполнить задания.
...
6) Скопировать файл hobby.txt в каталог A2 и переименовать его в файл Lab_№варианта.txt.
